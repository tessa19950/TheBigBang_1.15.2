...
public class JrYetiEntity extends AnimalEntity{	
	public JrYetiEntity(EntityType<? extends CreatureEntity> type, World worldIn) {
		super((EntityType<? extends AnimalEntity>) EntityInit.JRYETI_ENTITY, worldIn);
	}
